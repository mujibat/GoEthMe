...
contract GoEthMeTest is Helpers {
    ...
    function testCreateGofundme() public {
        ...
        goeth.createGofundme(_userA, "Wildlife", "anystring", 5 ether, 1 hours);
    ...
    function testNotInDuration() public {
       uint _ID = 1;
       goeth.createGofundme(_userA, "Wildlife", "anystring", 5 ether, block.timestamp + 1 hours);
       vm.warp(2 hours);
    ...
    function testTimeNotReached() public {
        vm.startPrank(_userA);
        uint id = 1;
        goeth.createGofundme(_userA, "Wildlife", "anystring", 5 ether, 12 hours);
